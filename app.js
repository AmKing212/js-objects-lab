...
game.party.push(pokemon[0], pokemon[3], pokemon[12]);
console.log(game.party);
...
game.party.forEach((poke,index)=> {
    ...
    game.party.splice(index, 1, pokemon[poke.number])
})
 console.log(game.party)
...
const starters = pokemon.filter(poke => poke.starter);
